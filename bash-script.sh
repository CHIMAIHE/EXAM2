...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=Iheanacho/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=Iheanacho/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=Iheanacho997/' /var/www/html/laravel/.env
